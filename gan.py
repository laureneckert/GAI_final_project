...
class GAN(object):
    def __init__(self, model_inputs=[],model_outputs=[],lambda_cycle=10.0,lambda_id=1.0): 
        ...
        loss_weights=[  1, 1,lambda_cycle, lambda_cycle, lambda_id, lambda_id ], optimizer=self.OPTIMIZER)
    ...
    def save_model(self):
        plot_model(self.gan_model, to_file=r'C:\Users\laure\Dropbox\School\BSE\Coursework\23 Fall\GenerativeAI\code for projects\GAIfinalproject\GAI_final_project\out\GAN_Model.png')
